package test.measureModel.units.resources;
...
import com.measureModel.units.providers.FahrenheitToKelvinConversionFunction;
import com.measureModel.units.providers.KelvinToCelsiusConversionFunction;
import com.measureModel.units.providers.KelvinToFahrenheitConversionFunction;

public class UnitsTestResource {

	private static UnitsTestResource uniqueInstance = new UnitsTestResource();
	
	private HashMap units;
		
	private UnitsTestResource() {
		units = new HashMap();
		initialize();
	}
	
	public static UnitsTestResource newInstance() {
